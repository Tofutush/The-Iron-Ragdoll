...
const authorsNotes = {
	1: `<p>This is the start of The Iron Ragdoll! Thanks a lot for your willingness to give this a shot!</p>
		<p>The Iron Ragdoll is also available on MSPFA, GlobalComix, ComicFury, NamiComi, Tapas, and Webtoons (see dropdown menu when hovering "Other" above). It would be so kind of you subscribe and leave comments!</p>`,
