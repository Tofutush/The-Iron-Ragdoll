const one = {
	img: document.getElementById('one-img'),
	h3: document.getElementById('one-name'),
	p: document.getElementById('one-desc'),
	vs: document.querySelector('.V')
}
const two = {
	img: document.getElementById('two-img'),
	h3: document.getElementById('two-name'),
	p: document.getElementById('two-desc'),
