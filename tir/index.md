...
<div class="grid">
  <a class="big" href="/characters/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'sparky pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'contact-round', 32 }} Characters</p></div>
  </a>
  <a href="/characters/list/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'cosmo pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'table-2', 32 }} Characters list</p></div>
  </a>
  <a href="/characters/relationships/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'tephra pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'git-fork', 32 }} Relationships</p></div>
  </a>
  <a href="/gallery/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'goose pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'images', 32 }} Gallery</p></div>
  </a>
  <a href="/stories/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'pumpkin pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'book-marked', 32 }} Stories</p></div>
  </a>
  <a class="big" href="/world/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'buttercup pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'earth', 32 }} World</p></div>
  </a>
  <a href="/world/overview/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'melody pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'square-chart-gantt', 32 }} Overview</p></div>
  </a>
  <a href="/world/history/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'alaska pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'scroll-text', 32 }} History</p></div>
  </a>
  <a href="/about/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'qibli pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'info', 32 }} About</p></div>
  </a>
  <a href="/fun/">
	<div class="card" style="background-image: url('{{ imageUrl 'gallery/', 'guillotine pop.png', 1000 |> htmlBaseUrl }}');"><p>{{ lucide 'ferris-wheel', 32 }} Fun</p></div>
  </a>
</div>
