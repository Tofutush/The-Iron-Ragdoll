...
People in TIR are named after concepts (for the most part; exceptions will always be present). For example, Willow is named after the tree, and Amber is named after the gemstone. In another language, their names would simply be whatever the willow tree and amber stone is called in that language[^1].
...
<figure><img class="max" src="/img/bg/alphabet/tl.png" alt="Tall loop"/><figcaption>Tall loop (middle / end, beginning)</figcaption></figure>
